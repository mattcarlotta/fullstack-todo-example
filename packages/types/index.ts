...
export const Completed = z.object({ completed: z.boolean() });
...
export const NewTodo = z.object({ todo: TODO })
export const UPDATED_TODO = z.object({ todo: TODO })
export type UpdatedTodo = z.infer<typeof UPDATED_TODO>
